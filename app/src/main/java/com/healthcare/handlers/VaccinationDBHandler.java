...
public class VaccinationDBHandler extends SQLiteOpenHelper {
    ...
    private static String COLUMN_VACCINATION_GIVEN = "vaccination_given";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String q1 = "Create Table " + TABLE_NAME1 + "( "
                ...
                "" + COLUMN_VACCINATION_GIVEN + " varchar(20))";
    ...
    public boolean addChild(ChildDetails childDetails) {
        ...
        for (int i = 0; i < vaccineDetails.size(); i++) {
            ...
            contentValues1.put(COLUMN_VACCINATION_GIVEN, vaccineDetails.get(i).given);
    ...
    public Cursor getVaccinesByName(String name){
        SQLiteDatabase db = getWritableDatabase();
        Cursor cursor= db.rawQuery("select * from " + TABLE_NAME1 + " where " + COLUMN_NAME + " = '" + name + "'",null);
        return cursor;
